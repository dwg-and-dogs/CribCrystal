...
ChuckGroup:
	...
	db 30, POLIWRATH,  HYPNOSIS, MIND_READER, CRABHAMMER, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  THUNDER_WAVE, CRABHAMMER, SLAM, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 40, KINGDRA,    SMOKESCREEN, CRABHAMMER, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 35, MEGANIUM,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 37, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	...
	db 38, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 38, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 41, FERALIGATR, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
PKMNTrainerGroup:
	...
	db 100, ELEKID,    ICE_PUNCH, THUNDERPUNCH, THUNDER_WAVE, PSYCHIC_M
	db 100, SMOOCHUM,  BLIZZARD, PSYCHIC_M, LOVELY_KISS, ATTRACT
	db 100, MAGBY,     FIRE_BLAST, IRON_TAIL, SMOKESCREEN, THUNDERPUNCH
	db 100, CHANSEY,   COUNTER, TOXIC, SEISMIC_TOSS, SOFTBOILED
	db 100, MUNCHLAX,  BODY_SLAM, REST, SLEEP_TALK, CURSE
	db 100, SUDOWOODO, ROCK_SLIDE, EARTHQUAKE, ROLLOUT, KARATE_CHOP
	db -1 ; end
...
KarenGroup: 
	...
	db 46, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 47, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 46, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 47, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db 50, TYRANITAR,  CURSE, ROCK_SLIDE, SANDSTORM, CRUNCH
	db -1 ; end
...
ChampionGroup:
	...
	db 42, GYARADOS,   FLAIL, RAIN_DANCE, CRABHAMMER, HYPER_BEAM
	db 45, DRAGONITE,  THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	db 45, DRAGONITE,  THUNDER_WAVE, TWISTER, BLIZZARD, HYPER_BEAM
	db 44, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 47, DRAGONITE,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 62, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 62, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 63, OMASTAR,    BITE, CRABHAMMER, PROTECT, SPIKE_CANNON
	db 65, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 63, KABUTOPS,   SLASH, CRABHAMMER, ENDURE, GIGA_DRAIN
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 58, GOLDUCK,    CRABHAMMER, DISABLE, PSYCH_UP, PSYCHIC_M
	db 58, QUAGSIRE,   CRABHAMMER, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 60, LAPRAS,     CRABHAMMER, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 63, STARMIE,    CRABHAMMER, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end
...
ScientistGroup:
	...
	db 31, MAGNEMITE, 	THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SUPERSONIC
	db 31, MAGNEMITE, 	THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SUPERSONIC
	db 31, MAGNEMITE, 	THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SUPERSONIC
	db -1 ; end
...
SchoolboyGroup:
	...
	db 55, VILEPLUME,  SLEEP_POWDER, PETAL_DANCE, SLUDGE_BOMB, STUN_SPORE
	db -1 ; end
...
LassGroup:
	...
	db 36, GOLDUCK,    DISABLE, CRABHAMMER, PSYCHIC_M, SCREECH
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 39, KINGLER,    KINGS_ROCK,   CRABHAMMER, STOMP, GUILLOTINE, BLIZZARD
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 33, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	...
	db 40, SANDSLASH,  SAND_ATTACK, POISON_STING, SLASH, SWIFT
	db -1 ; end
	...
	db 58, RHYHORN,    ROCK_SLIDE, EARTHQUAKE, STOMP, SCARY_FACE
	db 55, CHARMELEON, FLAMETHROWER, IRON_TAIL, SMOKESCREEN, BODY_SLAM
	db 55, WARTORTLE,  HYDRO_PUMP, BODY_SLAM, SKULL_BASH, SCARY_FACE
	db -1 ; end
	...
	db 37, DRAGONAIR,  WRAP, CRABHAMMER, DRAGON_RAGE, SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 40, BLASTOISE,  BITE, CURSE, CRABHAMMER, RAIN_DANCE
	db -1 ; end
	...
	db 37, BULBASAUR,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 37, IVYSAUR,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 37, VENUSAUR,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 38, STARMIE,    NO_ITEM,      DOUBLE_TEAM, PSYCHIC_M, CRABHAMMER, CONFUSE_RAY
	db 40, NIDOQUEEN,  PINK_BOW,     EARTHQUAKE, DOUBLE_KICK, TOXIC, BODY_SLAM
	db 38, STARMIE,    NO_ITEM,      BLIZZARD, PSYCHIC_M, CRABHAMMER, RECOVER
	db -1 ; end
	...
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db 35, SEADRA,     SWIFT, LEER, CRABHAMMER, TWISTER
	db -1 ; end
...
SabrinaGroup:
	...
	db 55, HYPNO,   BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
...
FisherGroup: ;
	...
	db 34, SEAKING,    SUPERSONIC, CRABHAMMER, FLAIL, FURY_ATTACK
	db 34, SEAKING,    SUPERSONIC, CRABHAMMER, FLAIL, FURY_ATTACK
	...
	db 35, QWILFISH,   TOXIC, MINIMIZE, CRABHAMMER, PIN_MISSILE
	db 39, SEAKING,    ENDURE, FLAIL, FURY_ATTACK, CRABHAMMER
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, CRABHAMMER, FURY_ATTACK
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, CRABHAMMER, FURY_ATTACK
	db 37, QWILFISH,   ROLLOUT, CRABHAMMER, PIN_MISSILE, TAKE_DOWN
	db -1 ; end
...
SailorGroup:
	...
	db 38, POLIWRATH,  CRABHAMMER, STRENGTH, ICE_PUNCH, SUBMISSION
	db -1 ; end
...
SuperNerdGroup:
	...
	db 42, SEADRA,     SMOKESCREEN, TWISTER, SURF, CRABHAMMER
	db -1 ; end
...
Rival2Group:
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, FERALIGATR, CRABHAMMER, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
BlaineGroup:
	...
	db 62, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 67, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
...
BurglarGroup:
	...
	db 30, GROWLITHE,  ROAR, EMBER, LEER, TAKE_DOWN
...
PsychicGroup:
	...
	db 36, NATU,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
...
CamperGroup:
	...
	db 54, NIDOKING,   EARTHQUAKE, SLUDGE_BOMB, THRASH, HORN_ATTACK
	db -1 ; end
	...
	db 34, GOLDUCK,    DISABLE, PSYCHIC_M, CRABHAMMER, PSYCH_UP
	db -1 ; end
...
RedGroup:
	...
	db 77, BLASTOISE,  RAIN_DANCE, CRABHAMMER, BLIZZARD, WHIRLPOOL
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 68, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 66, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 68, RHYDON,     FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
...
GruntFGroup:
	...
	db 27, EKANS,      WRAP, LEER, POISON_STING, BITE
	db 27, GLOOM,      ABSORB, SWEET_SCENT, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
