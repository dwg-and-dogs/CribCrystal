...
CianwoodCity_MapEvents:
	...
	object_event 10, 14, SPRITE_SMOOCHUM, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_SUICUNE_AT_CIANWOOD_CITY
