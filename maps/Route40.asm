...
Route40MonicaCallback:
	...
	ifequal TUESDAY, .MonicaAppears
	ifequal WEDNESDAY, .MonicaAppears
	ifequal THURSDAY, .MonicaAppears
	ifequal FRIDAY, .MonicaAppears
	ifequal SATURDAY, .MonicaAppears
	ifequal SUNDAY, .MonicaAppears
