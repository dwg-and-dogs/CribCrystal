...
Route36ArthurCallback:
	readvar VAR_WEEKDAY
	ifequal MONDAY, .ArthurAppears	
	ifequal TUESDAY, .ArthurAppears
	ifequal WEDNESDAY, .ArthurAppears
	ifequal THURSDAY, .ArthurAppears
	ifequal FRIDAY, .ArthurAppears
	ifequal SATURDAY, .ArthurAppears
	ifequal SUNDAY, .ArthurAppears
...
Route36_MapEvents:
	...
	def_object_events
	object_event 19, 13, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPsychicMark, -1;
	object_event 22, 13, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, TrainerSchoolboyAlan1, -1;
	...
	object_event 21,  6, SPRITE_SMOOCHUM, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_SUICUNE_ON_ROUTE_36
