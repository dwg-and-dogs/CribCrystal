...
; Johto story events
	...
	const EVENT_ECRUTEAK_ROUTE38BLOCK1
	const EVENT_ECRUTEAK_ROUTE38BLOCK2
...
; Crystal-exclusive events in Johto
	...
	const EVENT_ECRUTEAK_ROUTE42BLOCK1
	const EVENT_ECRUTEAK_ROUTE42BLOCK2
	const EVENT_MAHOGANY_GYM_BLOCK
...
; Kanto story events
	...
	const EVENT_GOT_TM14_BLIZZARD ;FROM MISTY
	const EVENT_GOT_TM_25_THUNDER ;FROM FLUE
	const EVENT_GOT_TM_33_ICE_PUNCH ;from sabrina
	const EVENT_GOT_TM_38_FIRE_BLAST ;BLAINE
	const EVENT_GOT_TM_41_THUNDERPUNCH ;SURGE
	const EVENT_GOT_TM_48_FIRE_PUNCH ;BROCK
...
; Johto itemballs
	...
	const EVENT_TIN_TOWER_1F_CURSE
